...
const Footer = () => {
  ...
  return (
    <footer className="main-footer">
      <div className="wrapper pt-[4rem] flex gap-[5rem]">
        <div className="brand-details flex flex-col gap-[2rem] min-w-[40rem]">
          ...
          <ul className="social-links flex item-center gap-[1.5rem]">
            <li className="link icon-container cursor-pointer" style={{ "--size": "2.5rem" }}>
